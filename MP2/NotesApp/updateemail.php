...
$message .= "update.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";}

include "email.php";

if(sendEmail($newemail, 'Email Update for you Online Notes App', $message)){
