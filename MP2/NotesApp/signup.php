...
if($results > 0){
    echo '<div class="alert alert-danger">'.$username.' That username is already registered. Do you want to log in?</div>';  exit;
}
...
if (sendEmail($email, "Complete Your Registatration", $message))
{
