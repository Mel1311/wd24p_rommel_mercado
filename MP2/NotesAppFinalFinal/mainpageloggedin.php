          ...
          <div class="row">
              <div class="col-md-offset-3 col-md-6">
                  <div class="buttons">
                      ...
                      <button id="edit" type="button" class="btn btn-info btn-lg pull-right">Delete Note</button>
                      <button id="done" type="button" class="btn green btn-lg pull-right">Done</button>
                      <button id="allNotes" type="button" class="btn btn-info btn-lg">Save Note</button>
                  </div>
