		...
		<div class="col-md-8">
			<div class="card card-outline card-dark">
				<div class="card-header">
					...
					<div class="card-tools">
						<button class="btn btn-light bg-gradient-white btn-sm" type="button" id="new_task"><i class="fa fa-plus"></i> New Task</button>
					</div>
				<?php endif; ?>
				</div>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					...
					<div class="card-tools">
						<button class="btn btn-light bg-gradient-white btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> New Productivity</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
